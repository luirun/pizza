...
class SlidersControllerTest < ActionController::TestCase
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post :create, slider: { artykul: @slider.artykul, krotki_opis: @slider.krotki_opis, tytul: @slider.tytul }
    end
  ...
  test "should update slider" do
    patch :update, id: @slider, slider: { artykul: @slider.artykul, krotki_opis: @slider.krotki_opis, tytul: @slider.tytul }
    assert_redirected_to slider_path(assigns(:slider))
  end
